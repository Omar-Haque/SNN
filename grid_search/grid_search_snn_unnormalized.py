...
class excitatory_neurons(nn.Module):
    ...
    def forward(self, x_exc: torch.Tensor, x_inh: torch.Tensor) -> torch.Tensor:
        ...
        max_v_indices: torch.Tensor = torch.argmax(self.v, dim=1) # this contains a 1D tensor containing the winning neuron for each image in the batch.
...
def run_grid_search():
    ...
    param_grid = {
        ...
        'lr_minus': [0.0001, 0.001],             # Weak vs Strong LTD
