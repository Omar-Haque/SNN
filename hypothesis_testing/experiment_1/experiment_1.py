# SPIKING HYPERPARAMETERS, CONDUCTANCE MODEL
...
class excitatory_neurons(nn.Module):
    ...
    def forward(self, x_exc: torch.Tensor, x_inh: torch.Tensor, learning: bool = True) -> torch.Tensor:
        ...
        _, topk_indices = torch.topk(competing_v, k=3, dim=1)
        ...
        if learning:
            ...
            # For biological accuracy. Empirically, the thresholds never seem to rise above 0 mV.
...
points_history = []
accuracy_history = []
snapshot_interval = 10 # Run an evaluation every 50 batches
...
for epoch in range(num_epochs):
    ...
    for batch_idx, (data, targets) in enumerate(train_loader):
        ...
        # if (total_points_processed == 120000 or total_points_processed == 160000):
