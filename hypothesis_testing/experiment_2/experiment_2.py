# CONDUCTANCE HYPERPARAMETERS, SIMPLIFIED MODEL
...
points_history = []
accuracy_history = []
snapshot_interval = 50 # Run an evaluation every 50 batches
...
for epoch in range(num_epochs):
    ...
    for batch_idx, (data, targets) in enumerate(train_loader):
        ...
        if (total_points_processed == 2016 or total_points_processed == 160000):
