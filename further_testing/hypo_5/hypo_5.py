...
for epoch in range(num_epochs):
    ...
    for batch_idx, (data, targets) in enumerate(train_loader):
        ...
        if batch_idx % snapshot_interval == 0:
            ...
            print(f"Accuracy: {snapshot_acc:.2f}% | Timestep Weight Frobenius Norm Sum: {batch_frobenius_sum:.4f}")
...
ax1.plot(points_history, accuracy_history, linestyle='-', color='blue', linewidth=2, label="Accuracy")
ax1.tick_params(axis="y", labelcolor="blue")
ax1.grid(True, linestyle='--', alpha=0.7)

ax2 = ax1.twinx()  
ax2.set_ylabel("Timestep Weight Frobenius Norm Sum", color="purple")
ax2.plot(points_history, frobenius_norm_history, linestyle='--', color='purple', linewidth=2, label="Frobenius Norm")
ax2.tick_params(axis="y", labelcolor="purple")

plt.title(f"Accuracy vs. Weight Update Frobenius Norm ({model.num_neurons} Neurons)")
fig.tight_layout()
plt.show()
